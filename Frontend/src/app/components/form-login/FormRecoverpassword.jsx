...
function FormRecoverPassword({alert, alertok, handleonClickView,showPassword, errors, touched, showConfirmPassword}) {
  return (
    ...
    <p className="mt-4 text-gray-700 text-center mb-5 text-sm mx-4">
      Introduce una{" "}
      <span className=" font-bold text-black">nueva contraseña</span>{" "}
  ...
  <div>
    {alert.msg ? (
      ...
      <div className=" flex gap-1 text-GreenKeej justify-center items-center text-bold pt-2 ">
        <p className="text-GreenKeej font-bold text-center mb-4">
          {alertok.msg}
        </p>{" "}
        <Link
          href="/es/login"
          className="text-GreenKeej underline hover:text-GreenKeej-100 font-bold text-center mb-4"
        >
          {" "}
          Inicia sesión
        </Link>{" "}
